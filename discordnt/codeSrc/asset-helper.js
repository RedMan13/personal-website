...
export const Asset = {
    ...
    GuildMemberAvatar: map('guilds/{guild.id}/users/{user.id}/avatars/{member.avatar} *', ['png', 'jpeg', 'webp', 'gif']),
    AvatarDecoration: map('avatar-decoration-presets/{user.decoration}', ['png']),
    ...
    Sticker: map('stickers/{sticker.id}', ['png', 'lottie', 'gif']),
