...
const codes = {
    ...
    /** This code was used in  contexts to indicate that a request has been received by the server, but no status was available at the time of the response. */
    ...
    RequestTimeout: 408,
    /** This response is sent when a request conflicts with the current state of the server. In  remote web authoring, 409 responses are errors sent to the client so that a user might be able to resolve a conflict and resubmit the request. */
    Conflict: 409,
...
module.exports = { codes, handleReject }